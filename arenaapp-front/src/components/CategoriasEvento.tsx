...
interface CategoriasEventoProps {
  selected: string[]
  onChange: (values: string[]) => void
}

export default function CategoriasEvento({
  selected,
  onChange,
}: CategoriasEventoProps) {
  ...
  function toggleOption(cat: string) {
  ...
  const filtered = CATEGORIAS_EVENTO.filter((c) =>
